package app.reformcloud.rethink.application;
...
import app.reformcloud.rethink.RethinkApplication;
...
public class DatabaseRethinkAddonUpdater extends DefaultApplicationUpdateRepository {
    ...
    public boolean isNewVersionAvailable() {
        return !RethinkApplication.getInstance().getApplication().getApplicationConfig().getVersion().equals(this.newVersion);
    }
