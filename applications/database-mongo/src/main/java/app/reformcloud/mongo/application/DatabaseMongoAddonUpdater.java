package app.reformcloud.mongo.application;
...
import app.reformcloud.mongo.MongoApplication;
...
public class DatabaseMongoAddonUpdater extends DefaultApplicationUpdateRepository {
    ...
    public boolean isNewVersionAvailable() {
        return !MongoApplication.getInstance().getApplication().getApplicationConfig().getVersion().equals(this.newVersion);
    }
